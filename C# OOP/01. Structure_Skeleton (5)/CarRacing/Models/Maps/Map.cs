...
namespace CarRacing.Models.Maps
{
    public class Map : IMap
    {
        ...
        public string StartRace(IRacer racerOne, IRacer racerTwo)
        {
            ...
            var racerOneMultiplier = 0.0;
            var racerTwoMultiplier = 0.0;

            racerOneMultiplier = racerOne.RacingBehavior == "strict" ? 1.2 : 1.1;

            var racerOneChanceOfWinning = racerOne.Car.HorsePower * racerOne.DrivingExperience * racerOneMultiplier;

            racerTwoMultiplier = racerTwo.RacingBehavior == "strict" ? 1.2 : 1.1;
